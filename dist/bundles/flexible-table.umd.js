(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'into-pipes', 'drag-enabled'], factory) :
...
var TableViewComponent = /** @class */ (function () {
    ...
    TableViewComponent.prototype.initVisibleRows = function () {
        var result = [];
...
var TableSortDirective = /** @class */ (function () {
    ...
    TableSortDirective.prototype.headerColumnElements = function () {
        return this.el.nativeElement.parentNode.children;
    };
    TableSortDirective.prototype.findColumnWithID = function (id) {
        var list = this.headerColumnElements();
        var column = null;
        for (var i = 0; i < list.length; i++) {
            if (list[i].getAttribute("id") === id) {
    ...
    TableSortDirective.prototype.sort = function (icon) {
