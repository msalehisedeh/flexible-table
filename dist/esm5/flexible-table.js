import { Component, ViewContainerRef, Input, Output, EventEmitter, ViewChild, ElementRef, NgModule, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
var TablePaginationComponent = /** @class */ (function () {
    ...
    TablePaginationComponent.prototype.setWidth = function (width) {
        this.info.maxWidth = width + "px";
    };
    TablePaginationComponent.prototype.ready = function () {
        this.onready.emit(this);
        this.onchange.emit(this.info);
    };
    TablePaginationComponent.prototype.selectFirst = function () {
    ...
    TablePaginationComponent.prototype.selectNext = function () {
    ...
    TablePaginationComponent.prototype.selectPrev = function () {
        if (this.info.currentPage > 1) {
    ...
    TablePaginationComponent.prototype.selectLast = function () {
        if (this.info.currentPage < this.info.pages) {
    ...
    TablePaginationComponent.prototype.changeCurrent = function (ranger) {
    ...
    TablePaginationComponent.prototype.changeSize = function (sizer) {
...
TablePaginationComponent.ctorParameters = function () { return [
    { type: ElementRef, },
]; };
TablePaginationComponent.propDecorators = {
    "pager": [{ type: ViewChild, args: ['paginationWrapper',] },],
    "root": [{ type: ViewChild, args: ['paginationWrapper', { read: ViewContainerRef },] },],
...
var FlexibleTableComponent = /** @class */ (function () {
    function FlexibleTableComponent(intoPipe) {
        ...
        this.showConfigurationView = false;
        this.dragging = false;
        this.vocabulary = {
    ...
    FlexibleTableComponent.prototype.ngOnDestroy = function () {
    };
    FlexibleTableComponent.prototype.toggleConfigurationView = function () {
        this.showConfigurationView = !this.showConfigurationView;
    };
    FlexibleTableComponent.prototype.reconfigure = function (item) {
    ...
    FlexibleTableComponent.prototype.dragEnabled = function (medium) {
...
export { FlexibleTableComponent, TablePaginationComponent, FlexibleTableModule };
