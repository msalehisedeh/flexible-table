...
export class AppService extends DataService {
  private users: any[] = [
    {
      ...
      "isActive": false,
      "balance": "$2,866.70",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558073.png",
      "age": 39,
      "eyeColor": "blue",
      "name": "Mathis Morales",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$2,070.14",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558263.png",
      "age": 134,
      "eyeColor": "green",
      "name": "Tonya Sweeney",
      "gender": "female",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$1,883.90",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558173.png",
      "age": 121,
      "eyeColor": "blue",
      "name": "Nguyen Hubbard",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$3,666.56",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558244.png",
      "age": 37,
      "eyeColor": "brown",
    ...
    },
    {
      ...
      "isActive": true,
      "balance": "$2,665.18",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558233.png",
      "age": 28,
      "eyeColor": "green",
      "name": "Gilliam Walker",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": true,
      "balance": "$3,698.24",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558186.png",
      "age": 319,
      "eyeColor": "brown",
      "name": "Bernard Downs",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$2,351.14",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558183.png",
      "age": 28,
      "eyeColor": "brown",
      "name": "Cooke Sellers",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$3,756.37",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558164.png",
      "age": 36,
      "eyeColor": "brown",
      "name": "Jaime Woodard",
      "gender": "female",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$3,981.63",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558225.png",
      "age": 30,
      "eyeColor": "brown",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$3,524.69",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558210.png",
      "age": 31,
      "eyeColor": "brown",
      "name": "Maxine Bridges",
      "gender": "female",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$2,089.46",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558119.png",
      "age": 34,
      "eyeColor": "green",
      "name": "Craig Gibson",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$1,000.51",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558206.png",
      "age": 20,
      "eyeColor": "blue",
      "name": "Gould Holmes",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$3,977.01",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558179.png",
      "age": 40,
      "eyeColor": "green",
      "name": "Downs Kent",
      "gender": "male",
    ...
    },
    {
      ...
      "isActive": false,
      "balance": "$2,852.33",
      "picture": "https://cdn-icons-png.flaticon.com/128/4558/4558284.png",
      "age": 31,
      "eyeColor": "blue",
      "name": "Ramos England",
      "gender": "male",
  ...
  override getData(info: PaginationInfo, headers: FlexibleTableHeader[]): Observable<any[]> {
    const params: RequestParameterInterface[] = this.getRequestParams(headers);
    ...
    info.contentSize = this.users.length;

    // since we have hardcoded users, we need to sort and filter them here before rteturening the result
    const sortedList = [];
    const filteredList = [];
